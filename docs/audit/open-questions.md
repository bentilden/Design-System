...
- Should image alt text be required before publish, or handled as a content QA warning?
- Should the standalone image route enforce post-asset relations after legacy asset cleanup?
...
- Should recipe nutrition information remain modal-only, or should there be an inline fallback?
